<?php /*a:3:{s:69:"/www/wwwroot/www.lilymin.com/application/admin/view/article/type.html";i:1603770604;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_header.html";i:1614937591;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_footer.html";i:1615798732;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5" action="/article-type" method="get">
                                ...
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" name="name"  placeholder="请输入类型名" autocomplete="off" class="layui-input" <?php if((!empty($get['name']))): ?>value="<?php echo htmlentities($get['name']); ?>"<?php endif; ?>>
                                </div>
                                <div class="layui-inline layui-show-xs-block">
                        ...
                        <div class="layui-card-header">
							...
							<span style="float:right">类型：<span id="cp"><?php echo htmlentities($count); ?></span></span>
                        </div>
                            ...
                            <table class="layui-table layui-form">
							  ...
							  <?php foreach($data as $v): ?>
                                <tr>
                                  ...
                                  <td class="td-manage">
                                    <a title="编辑"  onclick="xadmin.open('编辑','/article-type-edit/<?php echo htmlentities($v['id']); ?>')" href="javascript:;">
