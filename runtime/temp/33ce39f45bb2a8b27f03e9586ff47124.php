<?php /*a:3:{s:73:"/www/wwwroot/www.lilymin.com/application/admin/view/kuaidi/logistics.html";i:1586834365;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_header.html";i:1614937591;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_footer.html";i:1615798732;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5" action="/kuaidi-logistics" method="get">
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" name="name"  placeholder="请输入物流名字" autocomplete="off" class="layui-input" <?php if((!empty($get['name']))): ?>value="<?php echo htmlentities($get['name']); ?>"<?php endif; ?>>
                                </div>
                                <div class="layui-inline layui-show-xs-block">
                        ...
                        <div class="layui-card-header">
							...
							<span style="float:right">服务商：<span id="cp"><?php echo htmlentities($count); ?></span></span>
                        </div>
                            ...
                            <table class="layui-table layui-form">
							  ...
							  <?php foreach($data as $v): ?>
                                <tr>
                                  ...
                                  <td><?php echo htmlentities($v['logo']); ?></td>
                                  <td class="td-status">
                                  ...
                                  <td class="td-manage">
                                    <a title="修改"  onclick="xadmin.open('修改','/kuaidi-edit/<?php echo htmlentities($v['id']); ?>',600,400)" href="javascript:;">
