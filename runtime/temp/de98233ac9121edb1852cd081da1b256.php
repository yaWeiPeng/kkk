<?php /*a:3:{s:75:"/www/wwwroot/www.lilymin.com/application/admin/view/visitcategory/list.html";i:1589787360;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_header.html";i:1614937591;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_footer.html";i:1615798732;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加分类','/visit-category-edit/add',600,300)"><i class="layui-icon"></i>添加</button>
                            ...
                            <table class="layui-table layui-form">
							  ...
							  <?php foreach($data as $v): ?>
                                <tr>
                                  ...
                                  <td class="td-manage">
                                    <a title="编辑"  onclick="xadmin.open('编辑','/visit-category-edit/<?php echo htmlentities($v['id']); ?>',600,300)" href="javascript:;">
