<?php /*a:3:{s:69:"/www/wwwroot/www.lilymin.com/application/admin/view/dynamic/list.html";i:1586829922;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_header.html";i:1614937591;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_footer.html";i:1615798732;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5" action="/dynamic" method="get">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加动态','/dynamic-edit/add')"><i class="layui-icon"></i>添加</button>
							<span style="float:right">动态数：<span id="cp"><?php echo htmlentities($count); ?></span></span>
						</div>
                            ...
                            <table class="layui-table layui-form">
							  ...
							  <?php foreach($data as $v): ?>
                                <tr>
                                  ...
                                  <td style="width:100px;height:100px"><img src="<?php echo htmlentities($v['avatarUrl']); ?>"></td>
                                  <td class="td-status">
                                  ...
                                  <td class="td-manage">
                                    <a title="编辑"  onclick="xadmin.open('编辑','/dynamic-edit/<?php echo htmlentities($v['id']); ?>')" href="javascript:;">
...
$.ajax({
	...
	success:function(data){
      ...
      $('body').on('click',".layui-layer-close",function(){
			var pic = JSON.parse(localStorage.getItem('lpicdynamic'));
			$.ajax({
				type:"post",
				url:'/delfiles',
				data:{data:pic},
