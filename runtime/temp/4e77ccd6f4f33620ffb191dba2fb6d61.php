<?php /*a:3:{s:69:"/www/wwwroot/www.lilymin.com/application/admin/view/article/edit.html";i:1587975986;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_header.html";i:1614937591;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_footer.html";i:1615798732;}*/ ?>
<!DOCTYPE html>
                ...
                <form class="layui-form">
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" id="title" name="title" required="" autocomplete="off" class="layui-input" <?php if((!empty($list['title']))): ?>value="<?php echo htmlentities($list['title']); ?>"<?php endif; ?>>
                      </div>
				  ...
				  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
						...
						<option value="<?php echo htmlentities($v['id']); ?>"  <?php if((!empty($list['tid']) && $list['tid'] == $v['id'])): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
						<?php endforeach; ?>
					  </select>
                      </div>
                      <div class="layui-form-mid layui-word-aux">
				  ...
				  <div class="layui-form-item">
                      ...
                      <div style="float: left;margin-right: 10px;">
						<div style="width:800px;height:600px">
							<textarea id="editor" type="text/plain"><?php if((!empty($list['content']))): ?><?php echo htmlentities($list['content']); ?><?php endif; ?></textarea>
						</div>
                      </div>
                      <div class="layui-form-mid layui-word-aux">
                          <span class="x-red">*</span>必填
