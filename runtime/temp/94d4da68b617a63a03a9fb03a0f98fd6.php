<?php /*a:1:{s:69:"/www/wwwroot/www.lilymin.com/application/admin/view/member-list1.html";i:1569382535;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="layui-row layui-col-space15">
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body ">
                            <table class="layui-table" lay-data="<?php echo url("","",true,false);?>" lay-filter="test">
                                <thead>
                                    <tr>
