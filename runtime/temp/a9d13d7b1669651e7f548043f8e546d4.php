<?php /*a:3:{s:75:"/www/wwwroot/www.lilymin.com/application/admin/view/visitcategory/edit.html";i:1588146258;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_header.html";i:1614937591;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_footer.html";i:1615798732;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="layui-row">
                <form class="layui-form">
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" id="key" name="key" lay-verify="required" autocomplete="off" class="layui-input" <?php if((!empty($list['key']))): ?>value="<?php echo htmlentities($list['key']); ?>"<?php endif; ?>>
                      </div>
                      <div class="layui-form-mid layui-word-aux">
                          <span class="x-red">*</span>必填，控制菜单显示
                      </div>
                  </div>
				  <?php if((!empty($list))): ?>
