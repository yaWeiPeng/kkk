<?php /*a:5:{s:62:"/www/wwwroot/www.lilymin.com/application/admin/view/novel.html";i:1620264270;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_header.html";i:1614937591;s:67:"/www/wwwroot/www.lilymin.com/application/admin/view/top/search.html";i:1616663437;s:65:"/www/wwwroot/www.lilymin.com/application/admin/view/top/curd.html";i:1616138187;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_footer.html";i:1620268209;}*/ ?>
<!DOCTYPE html>
...
<div class="layui-card-body ">
	<form class="layui-form layui-col-space5" action="/novel/index" method="get">
	<?php $tagField = new \think\template\taglib\caption\tagField;$tagFielddata = $tagField->getSearch("novel");foreach($tagFielddata as $k=>$v): if(($k=='date')): ?>
	...
	<div class="layui-inline layui-show-xs-block">
		<button class="layui-btn-danger layui-btn layui-btn-xs"  onclick="window.location.href='/novel/index'" href="javascript:;" >清空选择</button>
	</div>
</div>
<!-- <div class="layui-card-body ">
	<form class="layui-form layui-col-space5" action="/novel/index" method="get">
...
<div class="layui-card-header">
	...
	<?php endif; if(('/novel/edit')): ?>
	<button class="layui-btn" onclick="xadmin.open('添加','/novel/edit')"><i class="layui-icon"></i>添加</button>
	<?php endif; ?>
</div>
...
<div class="layui-card-body">
	<table class="layui-table layui-form">
		...
		<tr>
			...
			<td><?php echo htmlentities($v['cate']['name']); ?></td>
			...
			<?php if(($v['state']['state'] == 0)): ?>layui-btn-warm<?php else: ?>layui-btn-normal<?php endif; ?>" onclick="member_stop(this,'<?php echo htmlentities($v['id']); ?>')"><?php echo htmlentities($v['state']['text']); ?></span></td>
			<td class="td-serial-status"><span class="layui-btn layui-btn-mini 
			<?php if(($v['novel_state']['state'] == 0)): ?>layui-btn-warm<?php else: ?>layui-btn-normal<?php endif; ?>"><?php echo htmlentities($v['novel_state']['text']); ?></span></td>
			<td><?php echo htmlentities($v['update_time']); ?></td>
			<td class="td-manage">
			<button class="layui-btn layui-btn layui-btn-xs"  onclick="xadmin.open('更新章节','/novel/UpdateNovel?id=<?php echo htmlentities($v['id']); ?>')" ><i class="layui-icon">&#xe642;</i>更新章节</button>
