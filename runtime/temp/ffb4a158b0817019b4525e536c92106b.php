<?php /*a:3:{s:67:"/www/wwwroot/www.lilymin.com/application/admin/view/novel_edit.html";i:1616667690;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_header.html";i:1614937591;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_footer.html";i:1615798732;}*/ ?>
<!DOCTYPE html>
		...
		<div class="layui-input-inline">
			<select name="tagerurl">
				<?php foreach($url as $k=>$v): ?>
					<option value="<?php echo htmlentities($v['id']); ?>" <?php if(($k==0)): ?>selected<?php endif; ?>><?php echo htmlentities($v['url']); ?></option>
				<?php endforeach; ?>
			</select>
		</div>
	</div>
