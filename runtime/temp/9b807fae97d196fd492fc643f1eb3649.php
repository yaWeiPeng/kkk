<?php /*a:3:{s:69:"/www/wwwroot/www.lilymin.com/application/admin/view/article/list.html";i:1603770585;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_header.html";i:1614937591;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_footer.html";i:1615798732;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5" action="/article" method="get">
								...
								<div class="layui-inline layui-show-xs-block">
                      <select name="tid">
					  <option value=""  <?php if((!empty($get['tid']))): ?>selected<?php endif; ?>></option>
						 <?php foreach($type as $v): ?>
						<option value="<?php echo htmlentities($v['id']); ?>"  <?php if((!empty($get['tid']) && $get['tid'] == $v['id'])): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
						<?php endforeach; ?>
					  </select>
                                </div>
                                <div class="layui-inline layui-show-xs-block">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加文章','/article-edit/add')"><i class="layui-icon"></i>添加</button>
							<span style="float:right" class="layui-col-md3">文章数：<span id="cp"><?php echo htmlentities($count); ?></span></span>
						</div>
                            ...
                            <table class="layui-table layui-form">
							  ...
							  <?php foreach($data as $v): ?>
                                <tr>
                                  ...
                                  <td><?php echo htmlentities($v['type']['name']); ?></td>
                                  <td class="td-status">
