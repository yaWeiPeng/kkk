<?php /*a:5:{s:70:"/www/wwwroot/www.lilymin.com/application/admin/view/novelcategory.html";i:1616655890;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_header.html";i:1614937591;s:67:"/www/wwwroot/www.lilymin.com/application/admin/view/top/search.html";i:1616663437;s:65:"/www/wwwroot/www.lilymin.com/application/admin/view/top/curd.html";i:1616138187;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_footer.html";i:1615798732;}*/ ?>
<!DOCTYPE html>
...
<div class="layui-card-body ">
	<form class="layui-form layui-col-space5" action="/novelcategory/index" method="get">
	<?php $tagField = new \think\template\taglib\caption\tagField;$tagFielddata = $tagField->getSearch("novelcategory");foreach($tagFielddata as $k=>$v): if(($k=='date')): ?>
	...
	<div class="layui-inline layui-show-xs-block">
		<button class="layui-btn-danger layui-btn layui-btn-xs"  onclick="window.location.href='/novelcategory/index'" href="javascript:;" >清空选择</button>
	</div>
</div>
<!-- <div class="layui-card-body ">
	<form class="layui-form layui-col-space5" action="/novelcategory/index" method="get">
...
<div class="layui-card-header">
	<?php if(('/novelcategory/del')): ?>
	<button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>批量删除</button>
	<?php endif; if(('/novelcategory/edit')): ?>
	<button class="layui-btn" onclick="xadmin.open('添加','/novelcategory/edit')"><i class="layui-icon"></i>添加</button>
	<?php endif; ?>
</div>
...
function delAll (argument) {
	...
	layer.confirm('确认要删除吗？'+ids.toString(),function(index){
		//捉到所有被选中的，发异步进行删除
		delajax('post','/novelcategory/del',ids);
	});
}
</script>
<div class="layui-card-body ">
	<table class="layui-table layui-form">
		...
		<tr cate-id='<?php echo htmlentities($v["id"]); ?>' fid='<?php echo htmlentities($v["pid"]); ?>'>
			...
			<td><?php if((isset($v['son']) && $v['son']==1)): ?><i class="layui-icon x-show" status='true'>&#xe623;</i><?php endif; ?><?php echo htmlentities($v["name"]); ?></td>
			...
			<td class="td-manage">
				<button class="layui-btn layui-btn layui-btn-xs"  onclick="xadmin.open('编辑','/novelcategory/edit?id=<?php echo htmlentities($v['id']); ?>')" ><i class="layui-icon">&#xe642;</i>编辑</button>
