<?php /*a:5:{s:61:"/www/wwwroot/www.lilymin.com/application/admin/view/user.html";i:1616571275;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_header.html";i:1614937591;s:67:"/www/wwwroot/www.lilymin.com/application/admin/view/top/search.html";i:1616663437;s:65:"/www/wwwroot/www.lilymin.com/application/admin/view/top/curd.html";i:1616138187;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_footer.html";i:1615798732;}*/ ?>
<!DOCTYPE html>
...
<div class="layui-card-body ">
	<form class="layui-form layui-col-space5" action="/user/index" method="get">
	<?php $tagField = new \think\template\taglib\caption\tagField;$tagFielddata = $tagField->getSearch("user");foreach($tagFielddata as $k=>$v): if(($k=='date')): ?>
	...
	<div class="layui-inline layui-show-xs-block">
		<button class="layui-btn-danger layui-btn layui-btn-xs"  onclick="window.location.href='/user/index'" href="javascript:;" >清空选择</button>
	</div>
</div>
<!-- <div class="layui-card-body ">
	<form class="layui-form layui-col-space5" action="/user/index" method="get">
...
<div class="layui-card-header">
	...
	<?php endif; if(('/user/edit')): ?>
	<button class="layui-btn" onclick="xadmin.open('添加','/user/edit')"><i class="layui-icon"></i>添加</button>
	<?php endif; ?>
</div>
	...
	<table class="layui-table layui-form">
		...
		<?php foreach($data as $v): ?>
			<tr>
				...
				<td class="td-manage">
					<button class="layui-btn layui-btn layui-btn-xs"  onclick="xadmin.open('编辑','/user/edit?id=<?php echo htmlentities($v['id']); ?>')" ><i class="layui-icon">&#xe642;</i>编辑</button>
