<?php /*a:5:{s:69:"/www/wwwroot/www.lilymin.com/application/admin/view/top/database.html";i:1616479734;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_header.html";i:1614937591;s:67:"/www/wwwroot/www.lilymin.com/application/admin/view/top/search.html";i:1616663437;s:65:"/www/wwwroot/www.lilymin.com/application/admin/view/top/curd.html";i:1616138187;s:71:"/www/wwwroot/www.lilymin.com/application/admin/view/public/_footer.html";i:1620268209;}*/ ?>
<!DOCTYPE html>
...
<div class="layui-card-body ">
	<form class="layui-form layui-col-space5" action="/caption/index" method="get">
	<?php $tagField = new \think\template\taglib\caption\tagField;$tagFielddata = $tagField->getSearch("caption");foreach($tagFielddata as $k=>$v): if(($k=='date')): ?>
	...
	<div class="layui-inline layui-show-xs-block">
		<button class="layui-btn-danger layui-btn layui-btn-xs"  onclick="window.location.href='/caption/index'" href="javascript:;" >清空选择</button>
	</div>
</div>
<!-- <div class="layui-card-body ">
	<form class="layui-form layui-col-space5" action="/caption/index" method="get">
...
<div class="layui-card-header">
	...
	<?php endif; if(('/caption/edit')): ?>
	<button class="layui-btn" onclick="xadmin.open('添加','/caption/edit')"><i class="layui-icon"></i>添加</button>
	<?php endif; ?>
</div>
...
<div class="layui-card-body layui-table-body layui-table-main">
	<table class="layui-table layui-form">
		...
		<tr>
			...
			<td><?php echo htmlentities($v['model']); ?></td>
			...
			<td class="td-manage">
				<button class="layui-btn layui-btn-warm layui-btn-xs"  onclick="xadmin.open('查看字段','/field/index?id=<?php echo htmlentities($v['id']); ?>&model=<?php echo htmlentities($v['model']); ?>')" ><i class="layui-icon">&#xe642;</i>查看字段</button>
				<button class="layui-btn layui-btn layui-btn-xs"  onclick="xadmin.open('编辑','/caption/edit?id=<?php echo htmlentities($v['id']); ?>')" ><i class="layui-icon">&#xe642;</i>编辑</button>
				<?php if(($v['type']['type'] == 0)): ?>
